...
const Home = () => {
  ...
  useGSAP(function(){
    if(panelOpen){
      gsap.to(panelRef.current,{height:'77%',padding:24})
  ...
  return (
    <div className='h-screen relative overflow-hidden'>
      ...
      <div className='flex flex-col justify-end absolute h-screen top-0 w-full'>
        ...
        <div ref={vehiclePanelRef} className='fixed z-10 bottom-0 translate-y-full w-full  px-3  py-6 bg-white'>
            <h3 className='text-2xl font-semibold mb-5'>Choose a ride</h3>
            <div className='w-full p-2 border-2 mb-2 active:border-black rounded-xl  flex items-center justify-between '>
