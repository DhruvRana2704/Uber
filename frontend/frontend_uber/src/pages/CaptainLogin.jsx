        ...
        <form onSubmit=
          ...
          <div>
            ...
            <input type="password" required
              ...
              placeholder="Enter Password" className='bg-[#eeeeee] mb-7 rounded px-4 py-2 w-full border-2 text-base placeholder:text-base' />
            <button className='bg-[#111] text-white font-semibold mb-3 rounded px-4 py-2 w-full  text-lg placeholder:text-base'>Login</button>
          </div>

          <p className='text-center text-base'> Wa'nna be a part of our Community?<Link to='/captain-signup' className='text-blue-600'> Register as a Captain</Link></p>
        </form>

      </div>

      <div>
        <Link to='/login' className='flex justify-center bg-[orange] text-white font-semibold mb-5 rounded px-4 py-2 w-full  text-lg '>Sign in as User</Link>
      </div>
    </div>
  )
}
